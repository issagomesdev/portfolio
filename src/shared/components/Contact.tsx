    ...
    const SMData: CardItem[] = [
        {
            ...
            link: 'https://www.youtube.com/@issagomesdev'
        },
        {
            id: 2,
            text: 'Instagram',
        ...
        },
        {
            ...
            text: 'GitHub',
            icon: 'uim:github',
            link: 'https://github.com/issagomesdev'
        },
        {
            id: 3,
            text: 'LinkedIn',
            icon: 'uim:linkedin',
            link: 'https://www.linkedin.com/in/issagomesdev/'
        }
    ];
    ...
    const SMComponent = ({ icon, link }: CardItem) => {
        return (
            <a href={link} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                <Box
                    sx={{
                        background: `linear-gradient(to bottom, #9b9d8745 0%, #777865 75%, #7E7F6C 100%)`,
                    }}
