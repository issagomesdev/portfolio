            ...
            <Box display={'flex'} flexWrap={'wrap'} justifyContent={'space-evenly'} width={'95%'} rowGap={theme.spacing(5)}>
                <Box display={'flex'} flexDirection={'column'} padding={theme.spacing(3)} gap={theme.spacing(3)} bgcolor={theme.palette.background.paper} borderRadius={'4px'} boxShadow={themeName === 'light' ? 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' : 'none'} width={'45%'}>
                    <Box display={'flex'} gap={theme.spacing(2)} alignItems={'center'}>
                        ...
                        <Box display={'flex'} flexDirection={'column'}>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Desenvolvimento</Typography>
                ...
                <Box display={'flex'} flexDirection={'column'} padding={theme.spacing(3)} gap={theme.spacing(3)} bgcolor={theme.palette.background.paper} borderRadius={'4px'} boxShadow={themeName === 'light' ? 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' : 'none'} width={'45%'}>
                    <Box display={'flex'} gap={theme.spacing(2)} alignItems={'center'}>
                        ...
                        <Box display={'flex'} flexDirection={'column'}>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Aplicativos</Typography>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Mobile</Typography>
                        </Box>
                    </Box>
                ...
                <Box display={'flex'} flexDirection={'column'} padding={theme.spacing(3)} gap={theme.spacing(3)} bgcolor={theme.palette.background.paper} borderRadius={'4px'} boxShadow={themeName === 'light' ? 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' : 'none'} width={'45%'}>
                    <Box display={'flex'} gap={theme.spacing(2)} alignItems={'center'}>
                        ...
                        <Box display={'flex'} flexDirection={'column'}>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Aplicativos </Typography>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Desktop</Typography>
                        </Box>
                    </Box>
                ...
                <Box display={'flex'} flexDirection={'column'} padding={theme.spacing(3)} gap={theme.spacing(3)} bgcolor={theme.palette.background.paper} borderRadius={'4px'} boxShadow={themeName === 'light' ? 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' : 'none'} width={'45%'}>
                    <Box display={'flex'} gap={theme.spacing(2)} alignItems={'center'}>
                        ...
                        <Box display={'flex'} flexDirection={'column'}>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>Desenvolvimento</Typography>
                            <Typography color={theme.palette.secondary.main} textTransform={'uppercase'} fontFamily={'Staatliches'} fontSize={theme.spacing(6)} lineHeight={theme.spacing(6)}>de Jogos</Typography>
                        </Box>
                    </Box>
